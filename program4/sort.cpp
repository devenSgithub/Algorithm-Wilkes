...
// Deven Schwartz
// 12/2/2021
// Project 4: Comparison of Mergesort, Heapsort, and QuickSort
// Assigment 4: Implement Heapsort, Mergesort, and QuickSort
// Description: sorts an array of ints in heap merge and quick sort.
// Flow: Prgram takes a file with ints and creates arrays to be sorted by heapsort, quicksort, and mergesort then prints the operations and assignments done by each.
...
//
//Testing: I have tested my code and have found no problems.   
//1.) 
//

//Time: ~3 hours. Not sure on the exact time spent
...
int main(){
    ...
    cout<<"Assignment 4: Comparison of Mergesort, Heapsort, and QuickSort"<<endl;
    cout<<"Sorting an file of ints and comparing the operations and assignments done by each sort.\n"<<endl;
    //
